  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-white to-pink-100 text-gray-800">
      ...
      <nav className="flex justify-between items-center px-6 py-4 backdrop-blur-md bg-white/60 shadow-md fixed top-0 w-full z-50">
        <h1 className="text-2xl font-bold text-pink-700">TravelTales</h1>
        <button
          onClick={handleShareClick}
          className="px-4 py-2 bg-pink-700 text-white rounded-xl hover:bg-pink-600 transition cursor-pointer"
        >
          Share Your Tale
        </button>
      </nav>
      ...
      {/* Hero Section */}
      <section className="flex flex-col bg-gradient-to-br from-blue-200 via-white to-pink-300 items-center justify-center text-center pt-36 pb-20 px-4">
        ...
        <Link href="/explore">
          <button className="bg-pink-700 text-white px-6 py-3 rounded-full text-lg shadow-lg hover:bg-pink-600 transition cursor-pointer">
            Explore Tales
          </button>
        </Link>
      </section>
      ...
      <section className="grid md:grid-cols-3 gap-8 px-6 md:px-20 py-16 bg-white/50 backdrop-blur-lg rounded-t-3xl shadow-inner">
        {[
          ...
          <div key={i} className="bg-gradient-to-br from-blue-200 via-white to-pink-300 rounded-2xl p-6 shadow-md hover:shadow-xl transition">
